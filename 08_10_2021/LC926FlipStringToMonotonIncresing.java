public class LC926FlipStringToMonotonIncresing {
    public int minFlipsMonoIncr(String s) {
        // dp[i][0] min flips to make substring(0, i) increading when ending with 0 after fliping
        // dp[i][1] min flips to make substring(0, i) increading when ending with 1 after fliping
